...
*	@param pszBaseClassName Class or interface to inherit from. Can be a list of classes/interfaces.
...
*	@param pszCPPBaseClassName Registered name of the class that provides base class method calling features. Can be null, in which case no BaseClass member is defined.
